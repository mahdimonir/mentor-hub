        ...
        <div className="bg-white rounded-lg border px-3">
          <ScrollArea>
            <TabsList className="p-0 bg-background justify-start rounded-none h-13">
              <TabsTrigger value="summary" className="completed-state-tab">
                <BookOpenTextIcon />
                Summary
              </TabsTrigger>
              <TabsTrigger value="transcript" className="completed-state-tab">
                <FileTextIcon />
                Transcript
              </TabsTrigger>
              <TabsTrigger value="recording" className="completed-state-tab">
                <FileVideoIcon />
                Recording
              </TabsTrigger>
              <TabsTrigger value="chat" className="completed-state-tab">
                <SparklesIcon />
                Ask AI
              </TabsTrigger>
            </TabsList>
